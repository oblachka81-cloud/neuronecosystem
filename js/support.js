...
const SUPPORT_FAQ = {
  ru: [
    ...
    { q: '⚡ Что такое IMPULSE?',a: 'Внутренняя валюта игрового хаба NEURON: 5 игр (FORTUNA, SPARK, XXI, KRASH, MINES). Покупайте за COGNIQ (1:5) или Stars. Ежедневный бонус 500 IMPULSE.'},
  ...
  en: [
    ...
    { q: '⚡ What is IMPULSE?',a: 'Internal currency of the NEURON gaming hub: 5 games (FORTUNA, SPARK, XXI, KRASH, MINES). Buy with COGNIQ (1:5) or Stars. Daily bonus 500 IMPULSE.'},
  ...
  fr: [
    ...
    { q: '⚡ IMPULSE?',a: 'Monnaie interne du hub de jeux NEURON : 5 jeux (FORTUNA, SPARK, XXI, KRASH, MINES). Achète avec COGNIQ (1:5) ou Stars. Bonus quotidien 500 IMPULSE.'},
  ...
  es: [
    ...
    { q: '⚡ ¿IMPULSE?',a: 'Moneda interna del hub de juegos NEURON: 5 juegos (FORTUNA, SPARK, XXI, KRASH, MINES). Compra con COGNIQ (1:5) o Stars. Bono diario 500 IMPULSE.'},
