  ...
  root.innerHTML = `
    <div class="exchange-card" style="max-width:480px;width:100%;margin:0 auto;padding:24px 16px;position:relative;z-index:3;">
      ...
      <div id="liveMarketWrap" style="margin:0 0 16px 0;border-radius:16px;padding:2px;background:linear-gradient(135deg,#ffffff 0%,#aebcd4 20%,#f2f6fc 45%,#8496b4 70%,#e6ecf5 100%);box-shadow:0 0 14px rgba(170,195,240,0.28);">
        <div style="border-radius:14px;background:rgba(6,10,22,0.85);backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px);padding:10px 10px 6px 10px;overflow:hidden;position:relative;">
