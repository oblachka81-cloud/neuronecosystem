...
root.innerHTML = `
  <div class="welcome-card">
    <img src="${phraseImg}" alt="NEURON" style="width:100%;max-width:400px;height:auto;display:block;margin:0 auto 12px;opacity:0.65;">
      ...
      <button id="miniRefBtn" style="position:relative;background:none;border:none;padding:0;width:100%;cursor:pointer;margin-top:10px;"><img src="/public/images/cogniq/btn_frame_invite.png" style="width:100%;display:block;opacity:0.65;"><span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-weight:600;font-size:0.88rem;color:#00ffaa;">${t.referralMiniBtn}</span></button>
      ${localStorage.getItem('channelBonusClaimed') === '1' ? '' : `
      <button onclick="window.open('https://t.me/NeuronGame_bot?start=channel','_blank');" style="position:relative;background:none;border:none;padding:0;width:100%;cursor:pointer;margin-top:8px;"><img src="/public/images/cogniq/btn_frame_channel.png" style="width:100%;display:block;opacity:0.65;"><span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-weight:600;font-size:0.88rem;color:#00ffaa;">📢 ${t.channelBonusBtn}</span></button>
      <button id="channelBonusBtn" style="position:relative;background:none;border:none;padding:0;width:100%;cursor:pointer;margin-top:8px;"><img src="/public/images/cogniq/btn_frame_channel.png" style="width:100%;display:block;opacity:0.65;"><span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-weight:600;font-size:0.88rem;color:#00ffaa;">${t.channelClaimBtn || '🎁 Забрать бонус'}</span></button>
    `}
      <button onclick="if(window.Telegram?.WebApp?.openLink){tg.openLink(window.location.origin + '/whitepaper.html');}else{window.open('/whitepaper.html','_blank');}" style="position:relative;background:none;border:none;padding:0;width:100%;cursor:pointer;margin-top:8px;"><img src="/public/images/cogniq/btn_frame_whitepaper.png" style="width:100%;display:block;opacity:0.65;"><span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-weight:600;font-size:0.88rem;color:#00ffaa;"> Whitepaper</span></button>
    </div>`;
